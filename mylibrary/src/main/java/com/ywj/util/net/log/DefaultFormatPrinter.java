 ...
 */
package com.ywj.util.net.log;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import android.text.TextUtils;

import com.ywj.util.util.CharacterHandler;
...
public class DefaultFormatPrinter implements FormatPrinter {
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, @NonNull String headers, @Nullable MediaType contentType,
        ...
        bodyString = ArmsRequestInterceptor.isJson(contentType) ? CharacterHandler.jsonFormat(bodyString)
                : ArmsRequestInterceptor.isXml(contentType) ? CharacterHandler.xmlFormat(bodyString) : bodyString;
