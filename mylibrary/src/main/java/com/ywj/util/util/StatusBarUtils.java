...
public class StatusBarUtils {
    ...
    public static final int DEFAULT_STATUS_BAR_ALPHA = 52;
    ...
    //设置状态栏文字颜色及图标为深色
    public static void setStatusBarTextColorDeep(Activity activity) {
...
//        activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    ...
    //设置状态栏文字颜色及图标为浅色
    public static void setStatusBarTextColorLight(Activity activity) {
        activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
//        activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
    }

    public static void setOppoLightStatusBarIcon(Activity activity, boolean lightMode) {
     ...
     * @param mContext
     */
    public static void initStatusBar(AppCompatActivity mContext) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            StatusBarUtils.setStatusBarTextColorDeep(mContext);
//            if (RomUtil.isOppo()) {
//                StatusBarUtils.setOppoLightStatusBarIcon(mContext, true);
//            } else {
//                StatusBarUtils.setStatusBarTextColorDeep(mContext);
//            }
        }
